...
def serializedATN():
    return [
        ...
        4,1,4,1,4,1,5,1,5,1,5,1,5,1,5,1,5,1,5,3,5,65,8,5,1,5,1,5,1,5,1,5,
        1,5,1,5,5,5,73,8,5,10,5,12,5,76,9,5,1,6,1,6,1,6,0,1,10,7,0,2,4,6,
        8,10,12,0,3,1,0,1,2,1,0,3,4,1,0,13,18,81,0,15,1,0,0,0,2,23,1,0,0,
        0,4,25,1,0,0,0,6,30,1,0,0,0,8,53,1,0,0,0,10,64,1,0,0,0,12,77,1,0,
        ...
        24,3,6,3,0,23,21,1,0,0,0,23,22,1,0,0,0,24,3,1,0,0,0,25,26,5,19,0,
        0,26,27,5,12,0,0,27,28,3,10,5,0,28,29,5,11,0,0,29,5,1,0,0,0,30,31,
        5,5,0,0,31,32,5,7,0,0,32,33,3,8,4,0,33,34,5,8,0,0,34,38,5,9,0,0,
        35,37,3,2,1,0,36,35,1,0,0,0,37,40,1,0,0,0,38,36,1,0,0,0,38,39,1,
        0,0,0,39,41,1,0,0,0,40,38,1,0,0,0,41,51,5,10,0,0,42,43,5,6,0,0,43,
        47,5,9,0,0,44,46,3,2,1,0,45,44,1,0,0,0,46,49,1,0,0,0,47,45,1,0,0,
        0,47,48,1,0,0,0,48,50,1,0,0,0,49,47,1,0,0,0,50,52,5,10,0,0,51,42,
        1,0,0,0,51,52,1,0,0,0,52,7,1,0,0,0,53,54,3,10,5,0,54,55,3,12,6,0,
        55,56,3,10,5,0,56,9,1,0,0,0,57,58,6,5,-1,0,58,65,5,19,0,0,59,65,
        5,20,0,0,60,61,5,7,0,0,61,62,3,10,5,0,62,63,5,8,0,0,63,65,1,0,0,
        0,64,57,1,0,0,0,64,59,1,0,0,0,64,60,1,0,0,0,65,74,1,0,0,0,66,67,
        ...
        1,0,0,0,74,75,1,0,0,0,75,11,1,0,0,0,76,74,1,0,0,0,77,78,7,2,0,0,
        78,13,1,0,0,0,8,17,23,38,47,51,64,72,74
    ]
...
class IfElseLangParser ( Parser ):
    ...
    def expr(self, _p:int=0):
        ...
        try:
            ...
            token = self._input.LA(1)
            if token in [19]:
                localctx = IfElseLangParser.IdContext(self, localctx)
                self._ctx = localctx
                _prevctx = localctx
                ...
                localctx = IfElseLangParser.NumContext(self, localctx)
                self._ctx = localctx
                _prevctx = localctx
                self.state = 59
            ...
            while _alt!=2 and _alt!=ATN.INVALID_ALT_NUMBER:
                if _alt==1:
                    ...
                    if la_ == 1:
                        localctx = IfElseLangParser.MulDivContext(self, IfElseLangParser.ExprContext(self, _parentctx, _parentState))
                        ...
                        localctx = IfElseLangParser.AddSubContext(self, IfElseLangParser.ExprContext(self, _parentctx, _parentState))
                        self.pushNewRecursionContext(localctx, _startState, self.RULE_expr)
                        self.state = 69
